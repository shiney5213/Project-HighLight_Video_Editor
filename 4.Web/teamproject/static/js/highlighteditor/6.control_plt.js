...
$(function() {
	...
	function searchGame(){
		...
		.done(function(data){
				// alert(data.searchImg_path);
				console.log(data.searchImg_path);
				$("#searchImage").attr("src", data.searchImg_path);
	...
	$('.analysisBtn').on('click', function(){
		...
		.done(function(data2){
			alert(data2);
			console.log('highlight', data2.highlight_path);
			k_path = data2.k_path;
			d_path = data2.d_path;
			a_path = data2.a_path;
			img_path = data2.highlight_path;
			$("#analysisImage").attr("src", img_path);
